    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-white rounded-full shadow-lg px-6 py-3 flex items-center gap-4 z-50">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            { titre: "Vues totales", valeur: annonces.reduce((acc, curr) => acc + curr.vues, 0), bgColor: "bg-purple-500", lightBg: "bg-purple-100" }
            ].map((stat, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-sm p-6 transform">
                ...
                <div className={`w-full h-1 ${stat.lightBg} rounded-full mt-4`}>
        ...
        <div className="max-w-7xl mx-auto mb-12">
            <div className='relative'>
                ...
                className="w-full px-6 py-2 rounded-2xl shadow-sm border border-gray-300 hover:ring-1 hover:ring-gray-400 outline-none transition-all bg-white pr-12"
                />
