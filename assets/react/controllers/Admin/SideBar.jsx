...
import { Home, Users, Building, ShoppingCart, LogOut, Wrench, File } from "lucide-react";
...
export default function Sidebar() {
    ...
    const menuItems = [
      ...
      { name: "Support", path: "/admin/support", icon: <Wrench size={20} /> },
      { name: "Rapports", path: "/admin/rapport", icon: <File size={20} /> },
    ];
